<!-- README được biên soạn dựa trên báo cáo đồ án “Xây dựng app bán hàng” của Nhóm 11 và cấu trúc mã nguồn trong project appbanhang. :contentReference[oaicite:0]{index=0} -->
